...
export-env {
    ...
    let virtual_env = 'C:\Users\COOPERS\Desktop\RYAN COOPER\Uni\Courses\Year 3\Semester 2\COMP 3161 - Introduction to Database Management Systems\Lab 3\Lab 3 from Scratch\lab3venv'
    let bin = 'Scripts'
